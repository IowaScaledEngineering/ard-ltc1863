...
#define LTC2499_CHAN_DIFF_2P_3N    (_BV(LTC186X_CONFIG_S0))
#define LTC2499_CHAN_DIFF_4P_5N    (_BV(LTC186X_CONFIG_S1))
#define LTC2499_CHAN_DIFF_6P_7N    (_BV(LTC186X_CONFIG_S1) | _BV(LTC186X_CONFIG_S0))
...
#define LTC186X_CHAN_SINGLE_7P     (_BV(LTC186X_CONFIG_SINGLE_END) | _BV(LTC186X_CONFIG_ODD) | _BV(LTC186X_CONFIG_S1) | _BV(LTC2499_CONFIG_S0))
